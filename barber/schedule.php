     ...
     <table class="menu-container" border="0">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,barber.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join barber on schedule.docid=barber.docid where barber.docid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
